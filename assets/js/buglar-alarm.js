// ==========================================
// VISIONANGLES SECURITY - VIDEO INTERCOM PAGE SCRIPTS
...
// Disable fullscreen on double-click for hero video
(function() {
...
class Particle {
    constructor() {
        ...
        this.color = `hsla(${goldHue}, ${saturation}%, ${lightness}%, ${this.opacity})`;
